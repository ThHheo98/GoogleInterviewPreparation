...
namespace CommonAlgo.ADT.Graphs._2015Tasks
{
    ...
    internal class GraphDeikstra
    {
        ...
        public void Test()
        {
            ...
            gr[0].Add(new WeightedPath(1, 2));
            gr[0].Add(new WeightedPath(4, 1));
            gr[0].Add(new WeightedPath(2, 7));
            gr[1].Add(new WeightedPath(2, 3));
            gr[2].Add(new WeightedPath(3, 1));
            gr[4].Add(new WeightedPath(2, 2));
            gr[4].Add(new WeightedPath(3, 6));
